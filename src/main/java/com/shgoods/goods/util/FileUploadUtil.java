...
public final class FileUploadUtil {
    ...
    private long maxSize=1024*1024*3; //500kb

    private long minSize=10*1024;  //50kb
    ...
    public String upload(MultipartFile multipartFile) throws IOException {
        ...
        String s = uploadUserImage(multipartFile);
    ...
    public  List<List<String>> upload(MultipartFile[] multipartFiles,String type) throws IOException{
        ...
        for (MultipartFile multipartFile : multipartFiles){
            ...
            List<String> strings = uploadGoodsImage(multipartFile,type);
    ...
    public String uploadUserImage(MultipartFile file) throws IOException {
        ...
        //电脑磁盘位置
        String uploadPath = this.imagePath+"/"+USERIMAGE+"/"+s+"/";
        ...
        return this.staticImagePath+"/"+USERIMAGE+"/"+s+"/"+s+"5050"+suffix;
    }

    public List<String> uploadGoodsImage(MultipartFile file,String type)  throws IOException{
        ...
        //电脑磁盘位置
        String uploadPath = this.imagePath+"/"+t+"/"+s+"/";
        ...
        paths.add(this.staticImagePath+"/"+t+"/"+s+"/"+newName);
